...
class ModelTowed(MainModel):
    def __init__(self, ship_data: dict, create_jacobians=True, parameters={}):
        super().__init__(create_jacobians=create_jacobians)

        self.setup_parameters(ship_data=ship_data, parameters=parameters)
    ...
    def setup_parameters(self, ship_data: dict, parameters: dict):
